...
const IN_MEMORY_USERS: InMemoryUser[] = [
  ...
  {
    id: 'usr_santosh_002',
    email: 'santosh.nair@gep.com',
    passwordHash: bcrypt.hashSync('Sn@2024x1', 10),
    firstName: 'Santosh',
    lastName: 'Nair',
    isActive: true,
    tenantId: 'tenant_demo_001',
    tenantName: 'Demo Organization',
    roles: ['viewer'],
    permissions: ['view:sales', 'view:arr', 'view:ai', 'view:settings'],
    avatarUrl: null,
    lastLoginAt: null,
    mfaEnabled: false,
  },
  {
    id: 'usr_jason_003',
    email: 'jason.griggs@gep.com',
    passwordHash: bcrypt.hashSync('Jg@2024x2', 10),
    firstName: 'Jason',
    lastName: 'Griggs',
    isActive: true,
    tenantId: 'tenant_demo_001',
    tenantName: 'Demo Organization',
    roles: ['viewer'],
    permissions: ['view:sales', 'view:ai', 'view:settings'],
    avatarUrl: null,
    lastLoginAt: null,
    mfaEnabled: false,
  },
  {
    id: 'usr_prasad_004',
    email: 'prasad.sawant@gep.com',
    passwordHash: bcrypt.hashSync('Ps@2024x3', 10),
    firstName: 'Prasad',
    lastName: 'Sawant',
    isActive: true,
    tenantId: 'tenant_demo_001',
  ...
  {
    id: 'usr_diane_005',
    email: 'diane.clark@gep.com',
    passwordHash: bcrypt.hashSync('Dc@2024x4', 10),
    firstName: 'Diane',
    lastName: 'Clark',
    isActive: true,
    tenantId: 'tenant_demo_001',
    tenantName: 'Demo Organization',
    roles: ['viewer'],
    permissions: ['view:arr', 'view:ai', 'view:settings'],
    avatarUrl: null,
    lastLoginAt: null,
    mfaEnabled: false,
  },
  {
    id: 'usr_mayur_006',
    email: 'mayur.jain@gep.com',
    passwordHash: bcrypt.hashSync('Mj@2024x5', 10),
    firstName: 'Mayur',
    lastName: 'Jain',
    isActive: true,
    tenantId: 'tenant_demo_001',
